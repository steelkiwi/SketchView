...
/*
 * Dialog to pick eraser size.
 */

public class EraserSizePickerDialog extends DialogFragment implements OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		getDialog().dismiss();
		((MainActivity) getActivity()).onEraserSizeSet(listAdapter.getItem(position));
	}
